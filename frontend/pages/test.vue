...
<template>
  <div clas="container">
    <div class="container mx-auto flex justify-center mt-4">
      <div class="hidden sm:hidden lg:flex"></div>
        ...
        <div class="gap-4">
          <div v-for="merchant in merchants" class="w-full gap-4 bg-[#282F7A]">
            ...
            <div class="rounded-md block sm:flex justify-between mb-4">
              <p class="w-[50rem] px-4 text-justify text-white mt-12">
                We build in settings that favor the future. Learn how we defy
                modern luxury, comfort, and convenience to originate lifestyle
                options for the coming generations.
              </p>
