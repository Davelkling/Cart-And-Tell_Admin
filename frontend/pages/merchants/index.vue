...
const { data: categories, refresh: refresh1 } = await useFetch<
...
async function create() {
  ...
  formDataCreate.append(
    ...
    formData.merchantRelationship.toString()
  );
  formDataCreate.append(
    "merchantStartValidity",
    formData.merchantStartValidity!.toString()
  );
  formDataCreate.append(
    "merchantEndValidity",
    formData.merchantEndValidity!.toString()
  );
  const token = useCookie("token");
...
const activeMerchants = computed(() =>
  merchants.value?.filter((merchant) => merchant.status != "Removed")
);
  ...
  <div class="bg-[#F8F9FD] w-[100vw]">
    <div class="flex justify-start">
      ...
      <div class="flex-1 shrink-0 h-[100svh] overflow-scroll relative flex">
        <div class="h-[80px]">
          <div
            class="bg-[#F8F9FD] w-[calc(100svw-400px)] p-4 text-center fixed"
          >
          ...
          <div class="bg-white rounded-3xl w-full p-4 h-full m-4 mt-8">
            ...
            >
              ...
              >
                ...
                <div class="mt-4">
                  <label class="block mb-1 font-bold text-lg" for="name"
                    >merchant relationship</label
                  >
                  <select class="h-12">
                    <option disabled selected value>
                      -- select an option --
                    </option>
                    <option :value="MerchantRelation.MerchantOwner">
                      Merchant Owner
                    </option>
                    <option :value="MerchantRelation.ExclusiveDistributor">
                      Exclusive Distributor
                    </option>
                    <option :value="MerchantRelation.NonExclusiveDistributor">
                ...
                <div class="mt-4">
                  <label class="block mb-1 font-bold text-lg" for="name"
                    >Merchant Start Validity</label
                  >
                  <input
                    v-model="formData.merchantStartValidity"
                    type="date"
                    name=""
                    id=""
                  />
                ...
                <div class="mt-4">
                  <label class="block mb-1 font-bold text-lg" for="name"
                    >Merchant End Validity</label
                  >
                  <input
                    v-model="formData.merchantEndValidity"
                    type="date"
                    name=""
                    id=""
                  />
            ...
            >
              ...
              >
                ...
                <p>
                  Note: Some Fields are Intentially left blank in order to not
                  edited
                </p>
                <div class="mt-4">
                  <label class="block mb-1 font-bold text-lg" for="name"
              ...
              >
                ...
                <div class="mt-4">
                  ...
                  >
                    {{
                      merchants!.filter(
                        (merchants) => merchants.id == selectedId
                      )[0].userId
                    }}
                  </p>
                </div>
                ...
                <div class="mt-4">
                  ...
                  <div class="flex justify-center items-center">
                    <img
                      ...
                      :src="merchants!.filter(merchants => merchants.id == selectedId)[0].image "
                      alt=""
                    />
                  </div>
                </div>
                ...
                <div class="mt-4">
                  ...
                  >
                  <NuxtLink
                    :to="merchants!.filter(merchants => merchants.id == selectedId)[0].proofOfAuthenticity"
            ...
            <div class="flex gap-4 justify-between items-center mt-[81px]">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                ...
                >
                  <td
                    ...
                    v-for="i in Array.from({ length: 13 })"
                  >
                ...
                >
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <p
                      class="w-[300px] text-ellipsis whitespace-nowrap overflow-hidden"
                    >
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <NuxtLink
                      :to="merchant.proofOfAuthenticity"
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <p>
                      {{
                        useDateFormat(
                          merchant.merchantStartValidity,
                          "YYYY-MM-DD"
                        ).value
                      }}
                    </p>
