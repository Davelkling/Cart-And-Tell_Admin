...
const {
  ...
  refresh,
  pending,
} = await useFetch<[{ id: number; name: string; icon: string }]>(
  `${API}/category`,
  {
    signal,
    lazy: true,
...
function openModal(e: any) {
  if (e.target!.value === "create") {
    ...
    formData.name = categories.value!.filter(
        ...
        <div class="bg-white rounded-3xl w-full p-4 h-full mt-4">
              ...
              <div class="mt-4">
                ...
                <div class="flex justify-center items-center">
                  <img
                    ...
                    :src="categories!.filter(category => category.id == selectedId)[0].icon"
                    alt=""
                  />
                </div>
              </div>
          ...
          <div class="flex justify-between items-center gap-4">
            <div class="flex justify-start items-center shrink-0">
              <p class="font-bold p-4 flex-1 basis-0">Total of Categories:</p>
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr
                v-if="!pending"
                v-for="category in searchTerm ? filteredCategories : categories"
                :key="category.id"
              >
