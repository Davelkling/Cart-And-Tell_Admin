...
async function approve() {
  ...
  const data = await $fetch<{ message: string }>(
    `${API}/merchant/${selectedId.value}/approve`,
    {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${token.value}`,
...
async function reject() {
  ...
  const token = useCookie("token");
  const data = await $fetch<{ message: string }>(
    `${API}/merchant/${selectedId.value}/reject`,
    {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${token.value}`,
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              >
                <td
                  ...
                  v-for="i in Array.from({ length: 9 })"
                >
              ...
              >
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <p>
                    {{
                      useDateFormat(merchant.merchantEndValidity, "YYYY-MM-DD")
                        .value
                    }}
                  </p>
                </td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  <button
                    ...
                    type="button"
                    class="text-blue-600 hover:text-red-900 px-4 py-2 border-2 rounded-full"
                  >
                    Delete
                  </button>
                  <button
                  ...
                  <button
                    ...
                    :id="merchant.id.toString()"
                    type="button"
                    class="text-red-600 hover:text-blue-900 px-4 py-2 border-2 rounded-full"
                  >
                    Reject
                  </button>
                </td>
