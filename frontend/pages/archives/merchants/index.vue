        ...
        <div class="bg-white rounded-3xl w-full p-4 h-full mt-4">
          ...
          <div class="flex justify-between items-center gap-4">
            <div class="flex justify-start items-center shrink-0">
              ...
              <p v-else class="font-bold">
                {{ merchants!.length ? merchants!.length : 0 }}
              </p>
            </div>
            <input
              v-model="searchTerm"
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr
                v-else
                v-for="merchant in searchTerm ? filteredMerchant : merchants"
                :key="merchant.id"
              >
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  <button
                    ...
                    type="button"
                    class="text-red-600 hover:text-indigo-900 px-4 py-2 border-2 rounded-full"
                  >
                    Delete
                  </button>
                </td>
